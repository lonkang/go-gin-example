...
import (
	...
	"github.com/lonkang/go-gin-example/models"
	"github.com/lonkang/go-gin-example/pkg/e"
	"github.com/lonkang/go-gin-example/pkg/setting"
	"github.com/lonkang/go-gin-example/pkg/util"
...
func EditArticle(c *gin.Context) {
	...
	valid.MaxSize(content, 65535, "content").Message("内容最长为255字符")
